...
Download the latest `CC-Switch-v{version}-Windows.exe` installer or `CC-Switch-v{version}-Windows-Portable.zip` portable version from the [Releases](../../releases) page.
