...
use crate::proxy::{
    ...
    server::ProxyState,
    types::{AppProxyConfig, CopilotOptimizerConfig, MultimodalRoutingConfig, OptimizerConfig, RectifierConfig},
    ProxyError,
};
...
pub struct RequestContext {
    ...
    /// 多模态路由配置
    pub multimodal_config: MultimodalRoutingConfig,
}
...
impl RequestContext {
    ...
    pub async fn new(
        ...
        let multimodal_config = state.db.get_multimodal_routing_config().unwrap_or_default();
