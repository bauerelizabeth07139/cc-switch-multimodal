...
export const settingsApi = {
  ...
  async getMultimodalRoutingConfig(): Promise<MultimodalRoutingConfig> {
    return await invoke("get_multimodal_routing_config");
  },

  async setMultimodalRoutingConfig(
    config: MultimodalRoutingConfig,
  ): Promise<boolean> {
    return await invoke("set_multimodal_routing_config", { config });
  },

  async listCompositeModels(): Promise<CompositeModelBinding[]> {
    return await invoke("list_composite_models");
  },

  async addCompositeModel(
    binding: CompositeModelBinding,
  ): Promise<boolean> {
    return await invoke("add_composite_model", { binding });
  },
