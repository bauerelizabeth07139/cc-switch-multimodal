...
Laden Sie das neueste Installationsprogramm `CC-Switch-v{version}-Windows.exe` oder die portable Version `CC-Switch-v{version}-Windows-Portable.zip` von der Seite [Releases](../../releases) herunter.
